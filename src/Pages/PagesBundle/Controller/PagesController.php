...
class PagesController extends Controller
{
	public function menuAction()
	{
		...
		return $this->render('PagesBundle:Default:pages/modulesUsed/menu.html.twig',compact('pages'));
	}
    ...
    public function pagesAction($id)
    {
        ...
        return $this->render('PagesBundle:Default:pages/layout/pages.html.twig',compact('page'));
    }
}
